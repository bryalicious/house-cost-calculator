...
const items = [
  ...
  },
  {
    ...
    "type": TYPES.RADIO,
    "excludes": [
      "Silver Selection - LVT (Bathrooms)",
      "Silver Selection - LVT",
      "Silver Selection - Carpets (1)",
      "Silver Selection - LVT Upgrade to Living Room",
      "Gold Selection - LVT (Bathrooms)",
      "Gold Selection - LVT",
      "Gold Selection - Carpets (1)",
      "Gold Selection - LVT Upgrade to Living Room"
    ],
  },
  {
  ...
  },
  {
    ...
    "type": TYPES.RADIO,
    "excludes": [
      "Bronze Selection - Vinyl (Bathrooms)",
      "Bronze Selection - Vinyl",
      "Bronze Selection - Carpets (1)",
      "Bronze Living Room Selection",
      "Gold Selection - LVT (Bathrooms)",
      "Gold Selection - LVT",
      "Gold Selection - Carpets (1)",
      "Gold Selection - LVT Upgrade to Living Room"
